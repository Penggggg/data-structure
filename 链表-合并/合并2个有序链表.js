 ...
 *
 */
var compose1 = function (list1, list2) {
    // 初始化一个链表
    var result = { value: '' };
    var resultCur = result;
    // 内部递归
    var innerCompose = function (listItem1, listItem2) {
        // 左边
        ...
        if ((!!listItem1 && !!listItem1.next) || (!!listItem2 && !!listItem2.next)) {
            innerCompose(listItem1 ? listItem1.next : undefined, listItem2 ? listItem2.next : undefined);
        }
    };
 ...
 */
var compose2 = function (list1, list2) {
